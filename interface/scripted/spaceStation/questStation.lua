...
textData.vin = {
	...
	chat11	= "If you haven't got an ^orange;Anvil^reset; or an ^orange;Armorworks^reset; built yet, you can still craft some basic weapons and protection via the ^green;[C]^reset;rafting Menu.",
	
	questStage0 = "So, you want to start progressing in ^cyan;Frackin Universe^reset;? The first thing you'll need to do is craft a ^orange;Machining Table^reset; via your ^green;[C]^reset;rafting Menu.\n\n",
	...
	questDecline	        = "Oh well, another time perhaps.\n\nYou should ^orange;complete my tasks^reset; before you ^orange;leave this planet^reset; though, or I won't be able to give you some ^orange;really handy gear^reset;!.",
