...
function getRecipes()
	return {
		...
		{ inputs = { automato = 1 }, outputs = { gene_harden = 1 } },
		{ inputs = { avesmingo = 1 }, outputs = { gene_chloroplast = 1 } },
		{ inputs = { banana = 1 }, outputs = { gene_resist = 1 } },
		{ inputs = { boneboo = 1 }, outputs = { gene_skeletal = 1 } },
		...
		{ inputs = { corn = 1 }, outputs = { gene_harden = 1 } },
		{ inputs = { crystalplant = 1 }, outputs = { gene_stealth = 1 } },
		{ inputs = { currentcorn = 1 }, outputs = { gene_mimetic = 1 } },
		{ inputs = { diodia = 1 }, outputs = { gene_assimilate = 1 } },
		{ inputs = { dirturchin = 1 }, outputs = { gene_muscle = 1 } },
		{ inputs = { eggshoot = 1 }, outputs = { gene_avian = 1 } },
		{ inputs = { feathercrown = 1 }, outputs = { gene_stimulant = 1 } },
		{ inputs = { glowfibre = 1 }, outputs = { gene_bioluminescent = 1 } },
		{ inputs = { grapes = 1 }, outputs = { gene_resist = 1 } },
		{ inputs = { greenapple = 1 }, outputs = { gene_regen = 1 } },
		{ inputs = { kelp = 1 }, outputs = { gene_regen = 1 } },
		{ inputs = { kiwi = 1 }, outputs = { gene_harden = 1 } },
		{ inputs = { neonmelon = 1 }, outputs = { gene_assimilate = 1 } },
		{ inputs = { oculemon = 1 }, outputs = { gene_ocular = 1 } },
		{ inputs = { orange = 1 }, outputs = { gene_regen = 1 } },
		{ inputs = { pearlpea = 1 }, outputs = { gene_adaptivecell = 1 } },
		{ inputs = { pineapple = 1 }, outputs = { gene_harden = 1 } },
		{ inputs = { plantfibre = 1 }, outputs = { gene_reproductive = 1 } },
		{ inputs = { potato = 1 }, outputs = { gene_resist = 1 } },
		{ inputs = { pussplum = 1 }, outputs = { gene_muscle = 1 } },
		{ inputs = { redapple = 1 }, outputs = { gene_muscle = 1 } },
		{ inputs = { reefpod = 1 }, outputs = { gene_aquacelerity = 1 } },
		{ inputs = { rice = 1 }, outputs = { gene_defense = 1 } },
		{ inputs = { shroom = 1 }, outputs = { gene_poisonous = 1 } },
		{ inputs = { sugar = 1 }, outputs = { gene_stimulant = 1 } },
		{ inputs = { thornfruit = 1 }, outputs = { gene_defense = 1 } },
		{ inputs = { tomato = 1 }, outputs = { gene_nervebundle = 1 } },
		{ inputs = { toxictop = 1 }, outputs = { gene_poisonous = 1 } },
		{ inputs = { wartweed = 1 }, outputs = { gene_corrosive = 1 } },
		{ inputs = { wheat = 1 }, outputs = { gene_chloroplast = 1 } },
