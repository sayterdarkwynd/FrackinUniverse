...
function getRecipes()
	return {
		...
		{ inputs = { beeflowerseed = 1 }, outputs = { gene_regen = 1, gene_reproductive = 1 } },
		...
		{ inputs = { bonebooseed = 1 }, outputs = { gene_skeletal = 1 } },
		...
		{ inputs = { isn_meatplant = 1 }, outputs = { gene_void = 1 } },
		...
		{ inputs = { wildbeeflowerseed = 1 }, outputs = { gene_regen = 1, gene_reproductive = 1 } },
		...
		{ inputs = { wildbonebooseed = 1 }, outputs = { gene_skeletal = 1 } },
		...
		{ inputs = { wildisn_meatplant = 1 }, outputs = { gene_void = 1 } },
