...
function getRecipes()
	...
	{ inputs = { waterbucket = 1 }, outputs = { fu_salt = { 1, 1, 2 }, fu_oxygen = { 1, 1, 2 }, fu_hydrogen = { 2, 2, 3 } } },
	...
	{ inputs = { moondrone = 1 }, outputs = { rawminerals = { 2, 3, 4 } } },
	{ inputs = { moonqueen = 1 }, outputs = { rawminerals = { 2, 3, 4 } } },	
	{ inputs = { morbidcomb = 1 }, outputs = { rottingfleshmaterial = 2 }, timeScale = { nil, nil, 9.1 } },
	{ inputs = { morbiddrone = 1 }, outputs = { bone = { 2, 3, 4 } } },
	{ inputs = { morbidqueen = 1 }, outputs = { bone = { 2, 3, 4 } } },		
	...
	{ inputs = { magmacomb = 1 }, outputs = { corefragmentore = 1 } },
	{ inputs = { magmadrone = 1 }, outputs = { geneticmaterial = { 1, 1, 4 } } },
	{ inputs = { magmaqueen = 1 }, outputs = { geneticmaterial = { 1, 1, 4 } } },	
	...
	{ inputs = { bolt = 1 }, outputs = { rawminerals = { 1, 2, 3 } } },
	...
	{ inputs = { giantfloranpod = 1 }, outputs = { agaranichor = { 4, 4, 8 }, geneticmaterial = { 24, 24, 36 } } },
	...
	{ inputs = { metallic = 1 }, outputs = { rawminerals = { 1, 1, 2 } } },
	...
	-- tiles
	{ inputs = { shroomblockmaterial = 50 }, outputs = { shroom = { 1, 2, 4 } } },
	{ inputs = { fusavannahgrass = 50 }, outputs = { nutrientpaste = { 1, 2, 4 } } },
	{ inputs = { fualiengrass = 50 }, outputs = { rawminerals = { 1, 2, 4 } } },	
	{ inputs = { rainforestfloor = 50 }, outputs = { geneticmaterial = { 1, 2, 4 } } },
	{ inputs = { rainforestfloorflowers = 50 }, outputs = { tissueculture = { 1, 2, 4 } } },
	...
	{ inputs = { bloodsandmaterial = 50 }, outputs = { liquidoil = { 2, 2, 4 }, glass = { 1, 1, 1 } } },
	...
	{ inputs = { brickmaterial = 50 }, outputs = { rawminerals = { 2, 2, 4 } } },
	...
	{ inputs = { crystalsandmaterial = 50 }, outputs = { ff_silicon = { 1, 1, 2 }, glass = { 2, 2, 2 } } },
	...
	{ inputs = { charredfleshmaterial = 50 }, outputs = { fu_carbon = { 2, 2, 4 } } },
	{ inputs = { floweryblock = 50 }, outputs = { geneticmaterial = { 3, 3, 6 } } },
	{ inputs = { frozendirt = 50 }, outputs = { nutrientpaste = { 3, 3, 5 } } },
	{ inputs = { frozensand2material = 50 }, outputs = { ff_silicon = { 1, 1, 3 }, glass = { 1, 1, 1 } } },
	{ inputs = { frozensandmaterial = 50 }, outputs = { ff_silicon = { 1, 1, 3 }, glass = { 1, 1, 1 } } },
	...
	{ inputs = { glasssandmaterial = 50 }, outputs = { ff_silicon = { 1, 1, 2 }, glass = { 3, 4, 5 } } },
	{ inputs = { glowsandmaterial = 50 }, outputs = { ff_silicon = { 1, 1, 2 }, glass = { 1, 2, 2 } } },
	...
	{ inputs = { icecrystal = 5 }, outputs = { crystal = { 3, 5, 7 }, magnesiumsulfate = { 3, 5, 7 } } },
	...
	{ inputs = { chertmaterial = 50 }, outputs = { rawminerals = { 2, 2, 4 }, saltpeter = { 2, 3, 4 } } },	
	{ inputs = { limestonematerial = 50 }, outputs = { rawminerals = { 2, 2, 4 }, saltpeter = { 2, 3, 4 } } },
	...
	{ inputs = { moltensand = 50 }, outputs = { metalchunk = { 1, 1, 2 }, glass = { 1, 1, 1 } } },
	...
	{ inputs = { obsidian = 10 }, outputs = { rawminerals = { 3, 4, 6 } } },
	...
	{ inputs = { rainbowsandmaterial = 50 }, outputs = { ff_silicon = { 2, 2, 4 }, glass = { 2, 2, 2 } } },
	...
	{ inputs = { redsand = 50 }, outputs = { ff_silicon = { 1, 1, 2 }, glass = { 1, 1, 2 } } },
	{ inputs = { redsand2 = 50 }, outputs = { ff_silicon = { 1, 1, 3 }, glass = { 1, 1, 2 } } },
	...
	{ inputs = { automatoseed = 1 }, outputs = { tissueculture = { 3, 3, 5 } } },
	{ inputs = { avesmingoseed = 1 }, outputs = { tissueculture = { 3, 3, 5 } } },
	...
	{ inputs = { bonebooseed = 1 }, outputs = { bone = { 2, 2, 3 }, tissueculture = { 1, 1, 2 }  } },
	{ inputs = { brackentreeseed = 1 }, outputs = { silk = { 2, 3, 4 }, ff_resin = { 1, 1, 2 } } },
	{ inputs = { silkfibre = 5 }, outputs = { silk = { 1, 2, 3 } } },
	{ inputs = { caprioleplantseed = 1 }, outputs = { geneticmaterial = { 3, 3, 4 } } },
	{ inputs = { carrotseed = 1 }, outputs = { cellmateria = { 2, 2, 3 }, tissueculture = { 1, 1, 2 } } },
	...
	{ inputs = { cinnamonseed = 1 }, outputs = { fu_nitrogen = { 2, 2, 4 }, phosphorus = { 1, 2, 2 } } },
	{ inputs = { cocoaseed = 1 }, outputs = { tissueculture = { 1, 2, 3 }, phosphorus = { 1, 2, 2 } } },
	{ inputs = { coffeeseed = 1 }, outputs = { geneticmaterial = { 4, 4, 5 }, tissueculture = { 1, 1, 2 }  } },
	{ inputs = { coralcreepseed = 1 }, outputs = { geneticmaterial = { 5, 5, 6 }, tissueculture = { 1, 1, 2 }  } },
	{ inputs = { cornseed = 1 }, outputs = { geneticmaterial = { 1, 1, 2 }, tissueculture = { 1, 1, 2 }  } },
	...
	{ inputs = { diodiaseed = 1 }, outputs = { geneticmaterial = { 1, 1, 3 }, tissueculture = { 1, 1, 2 }  } },
	...
	{ inputs = { floralytplantseed = 1 }, outputs = { geneticmaterial = { 4, 6, 8 }, phosphorus = { 1, 2, 2 } } },
	{ inputs = { flowerblack = 1 }, outputs = { geneticmaterial = { 1, 1, 3 } } },
	{ inputs = { flowerbrown = 1 }, outputs = { geneticmaterial = { 1, 1, 3 } } },
	{ inputs = { flowergreen = 1 }, outputs = { geneticmaterial = { 1, 1, 3 } } },
	{ inputs = { flowergrey = 1 }, outputs = { geneticmaterial = { 1, 1, 3 } } },
	{ inputs = { flowerorange = 1 }, outputs = { geneticmaterial = { 1, 1, 3 } } },
	{ inputs = { flowerorchid = 1 }, outputs = { geneticmaterial = { 1, 1, 3 } } },
	{ inputs = { flowerorchid2 = 1 }, outputs = { geneticmaterial = { 1, 1, 3 } } },
	{ inputs = { flowerorchid3 = 1 }, outputs = { geneticmaterial = { 1, 1, 3 } } },
	{ inputs = { flowerpink = 1 }, outputs = { geneticmaterial = { 1, 1, 3 } } },
	{ inputs = { flowerpurple = 1 }, outputs = { geneticmaterial = { 1, 1, 3 } } },
	{ inputs = { flowerwhite = 1 }, outputs = { geneticmaterial = { 1, 1, 3 } } },
	{ inputs = { fubioshroomblue = 1 }, outputs = { biospore = { 3, 3, 5 } } },
	{ inputs = { fubioshroomgreen = 1 }, outputs = { biospore = { 3, 3, 5 } } },
	{ inputs = { fubioshroompurple = 1 }, outputs = { biospore = { 3, 3, 5 }, phosphorus = { 1, 2, 2 } } },
	...
	{ inputs = { garpberry = 4 }, outputs = { aliencompound = { 1, 2, 2 }, phosphorus = { 1, 2, 2 } } },
	...
	{ inputs = { hopsseed = 1 }, outputs = { geneticmaterial = { 3, 3, 4 }, phosphorus = { 1, 2, 2 } } },
	{ inputs = { ighantseed = 1 }, outputs = { tissueculture = { 3, 3, 5 }, phosphorus = { 1, 2, 2 } } },
	...
	{ inputs = { mintseed = 1 }, outputs = { geneticmaterial = { 4, 4, 5 }, phosphorus = { 1, 2, 2 } } },
	{ inputs = { miraclegrassseed = 1 }, outputs = { geneticmaterial = { 3, 3, 6 }, phosphorus = { 1, 2, 2 } } },
	{ inputs = { mireurchinseed = 1 }, outputs = { geneticmaterial = { 2, 2, 4 } } },
	{ inputs = { mutaviskseed = 1 }, outputs = { geneticmaterial = { 4, 4, 6 } } },
	{ inputs = { naileryseed = 1 }, outputs = { rawminerals = { 4, 4, 6 }, phosphorus = { 1, 2, 2 } } },
	{ inputs = { neonmelonseed = 1 }, outputs = { geneticmaterial = { 2, 2, 4 }, phosphorus = { 1, 2, 2 } } },
	{ inputs = { neuropodseed = 1 }, outputs = { tissueculture = { 2, 2, 4 } } },
	{ inputs = { nissseed = 1 }, outputs = { tissueculture = { 4, 4, 6 }, phosphorus = { 1, 2, 2 } } },
	{ inputs = { oculemonseed = 1 }, outputs = { tissueculture = { 3, 3, 4 }, phosphorus = { 1, 2, 2 } } },
	{ inputs = { oonfortaseed = 1 }, outputs = { biospore = { 1, 1, 3 }, phosphorus = { 1, 2, 2 } } },
	...
	{ inputs = { pineappleseed = 1 }, outputs = { geneticmaterial = { 5, 5, 7 }, tissueculture = { 1, 1, 2 }  } },
	{ inputs = { pinkloomseed = 1 }, outputs = { geneticmaterial = { 5, 5, 7 } } },
	{ inputs = { poetree = 1 }, outputs = { geneticmaterial = { 2, 2, 5 } } },
	{ inputs = { porphisplantseed = 1 }, outputs = { tissueculture = { 5, 5, 7 }, phosphorus = { 1, 2, 2 } } },
	...
	{ inputs = { sugarcaneseed = 1 }, outputs = { tissueculture = { 4, 4, 6 }, phosphorus = { 1, 2, 2 } } },
	{ inputs = { talonseedseed = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
	{ inputs = { teratomatoseed = 1 }, outputs = { tissueculture = { 4, 6, 7 }, phosphorus = { 1, 2, 2 } } },
	{ inputs = { tetherhookseed = 1 }, outputs = { tissueculture = { 3, 3, 4 } } },
	{ inputs = { thornitoxseed = 1 }, outputs = { tissueculture = { 4, 4, 7 } } },
	{ inputs = { tinselbush = 1 }, outputs = { tissueculture = { 2, 2, 5 } } },
	{ inputs = { tomatoseed = 1 }, outputs = { tissueculture = { 3, 3, 4 } } },
	{ inputs = { toxictopseed = 1 }, outputs = { tissueculture = { 4, 4, 6 }, phosphorus = { 1, 2, 2 } } },
	{ inputs = { tyvokkseed = 1 }, outputs = { tissueculture = { 5, 5, 8 } } },
	{ inputs = { vanusflowerseed = 1 }, outputs = { tissueculture = { 3, 3, 5 } } },
	{ inputs = { varanberryseed = 1 }, outputs = { tissueculture = { 1, 1, 2 } } },
	{ inputs = { vashtaplantseed = 1 }, outputs = { tissueculture = { 6, 6, 7 } } },
	{ inputs = { vextongueseed = 1 }, outputs = { tissueculture = { 2, 2, 4 }, phosphorus = { 1, 2, 2 } } },
	{ inputs = { victorleaf = 1 }, outputs = { tissueculture = { 2, 2, 5 } } },
	{ inputs = { voritseed = 1 }, outputs = { tissueculture = { 3, 3, 5 }, phosphorus = { 1, 2, 2 } } },
	{ inputs = { wartweedseed = 1 }, outputs = { tissueculture = { 3, 3, 5 }, phosphorus = { 1, 2, 2 } } },
	{ inputs = { wheatseed = 1 }, outputs = { tissueculture = { 4, 4, 5 }, phosphorus = { 1, 2, 2 } } },
	...
	{ inputs = { zathiseed = 1 }, outputs = { geneticmaterial = { 8, 8, 9 } } },
        -- MoreFarming mod Compat
	-- Boiled Food
 	{ inputs = { boiledartichokeMFM = 1 }, outputs = { tissueculture = { 3, 3, 5 } } },
 	{ inputs = { boiledbeetMFM = 1 }, outputs = { tissueculture = { 3, 3, 5 } } },
 	{ inputs = { boiledgreenbeanMFM = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
	-- Canned Food
 	{ inputs = { cannedfoodMFM = 1 }, outputs = { tissueculture = { 3, 3, 5 } } },
 	{ inputs = { cannedpastaMFM = 1 }, outputs = { tissueculture = { 3, 3, 5 } } },
 	{ inputs = { cannedplantsludgeMFM = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
	-- Seeds
	{ inputs = { appleMFMseed = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { artichokeMFMseed = 1 }, outputs = { tissueculture = { 3, 3, 5 } } },
 	{ inputs = { asparagusMFMseed = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { bambooMFMseed = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { beetMFMseed = 1 }, outputs = { tissueculture = { 3, 3, 5 } } },
 	{ inputs = { bellpeperMFMseed = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { blackberryPBJseed = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { blueberriesPBJseed = 1 }, outputs = { tissueculture = { 3, 3, 5 } } },
 	{ inputs = { broccoliMFMseed = 1 }, outputs = { tissueculture = { 3, 3, 5 } } },
 	{ inputs = { brusselsproutMFMseed = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { cauliflowerMFMseed = 1 }, outputs = { tissueculture = { 3, 3, 5 } } },
 	{ inputs = { cinnamonMFMseed = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { cocoaMFMseed = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { cucumberMSMseed = 1 }, outputs = { tissueculture = { 4, 4, 6 } } },
 	{ inputs = { dragonfruitMFMseed = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { dungrootMFMseed = 1 }, outputs = { geneticmaterial = { 3, 3, 5 } } },
 	{ inputs = { finkleMFMseed = 1 }, outputs = { tissueculture = { 3, 3, 5 } } },
 	{ inputs = { flytrapMFMseed = 1 }, outputs = { tissueculture = { 4, 4, 6 } } },
 	{ inputs = { garlicMFMseed = 1 }, outputs = { tissueculture = { 4, 4, 6 } } },
 	{ inputs = { garpberryMFMseed = 1 }, outputs = { tissueculture = { 3, 3, 5 } } },
	{ inputs = { gingerMSMseed = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { greatbambooMFMseed = 1 }, outputs = { tissueculture = { 4, 4, 6 } } },
 	{ inputs = { greenbeanMFMseed = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { holidayfirMFMseed = 1 }, outputs = { tissueculture = { 4, 4, 6 } } },
 	{ inputs = { jalapenopepperMFMseed = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { jelonMFMseed = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { oatsMFMseed = 1 }, outputs = { tissueculture = { 4, 4, 6 } } },
 	{ inputs = { onionMFMseed = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { orangeMFMseed = 1 }, outputs = { tissueculture = { 3, 3, 5 } } },
 	{ inputs = { palsterstickMFMseed = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { peaMFMseed = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { peanutPBJseed = 1 }, outputs = { tissueculture = { 3, 3, 5 } } },
 	{ inputs = { portabelloMFMseed = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { pricklypearMFMseed = 1 }, outputs = { tissueculture = { 3, 3, 5 } } },
 	{ inputs = { pumpkinMFMseed = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { raspberryPBJseed = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { rattanMFMseed = 1 }, outputs = { tissueculture = { 4, 4, 6 } } },
 	{ inputs = { reedBMBsprout = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { rutabagaMFMseed = 1 }, outputs = { tissueculture = { 4, 4, 6 } } },
 	{ inputs = { saguaroMFMseed = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { shadowbulbMFMseed = 1 }, outputs = { geneticmaterial = { 3, 3, 5 } } },
 	{ inputs = { strawberryPBJseed = 1 }, outputs = { tissueculture = { 2, 2, 4 } } },
 	{ inputs = { sugarbeetMFMseed = 1 }, outputs = { tissueculture = { 3, 3, 5 } } },
 	{ inputs = { sweetpotatoMFMseed = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { vanillabeanMFMseed = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { yeastMFMseed = 1 }, outputs = { tissueculture = { 3, 3, 5 } } },
	-- Produce
 	{ inputs = { artichokeMFM = 1 }, outputs = { tissueculture = { 3, 3, 5 } } },
 	{ inputs = { asparagusMFM = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { bamboostalkBMB = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { beetMFM = 1 }, outputs = { tissueculture = { 3, 3, 5 } } },
 	{ inputs = { blackberryPBJ = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { blueberriesPBJ = 1 }, outputs = { tissueculture = { 3, 3, 5 } } },
 	{ inputs = { broccoliMFM = 1 }, outputs = { tissueculture = { 3, 3, 5 } } },
 	{ inputs = { brusselsproutMFM = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { cauliflowerMFM = 1 }, outputs = { tissueculture = { 3, 3, 5 } } },
 	{ inputs = { cinnamonMFM = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { cucumberMSM = 1 }, outputs = { tissueculture = { 4, 4, 6 } } },
 	{ inputs = { dragonfruitMFM = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { finkleMFM = 1 }, outputs = { tissueculture = { 3, 3, 5 } } },
 	{ inputs = { garlicMFM = 1 }, outputs = { tissueculture = { 4, 4, 6 } } },
 	{ inputs = { garpberryMFM = 1 }, outputs = { tissueculture = { 3, 3, 5 } } },
	{ inputs = { gingerMSM = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { greenbeanMFM = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { greenbellpepperMFM = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { holidayfruitMFM = 1 }, outputs = { tissueculture = { 4, 4, 6 } } },
 	{ inputs = { jalapenopepperMFM = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { oatsMFM = 1 }, outputs = { tissueculture = { 4, 4, 6 } } },
 	{ inputs = { onionMFM = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { orangebellpepperMFM = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { orangeMFM = 1 }, outputs = { tissueculture = { 3, 3, 5 } } },
 	{ inputs = { palsterstickMFM = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { peaMFM = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { peanutPBJ = 1 }, outputs = { tissueculture = { 3, 3, 5 } } },
 	{ inputs = { portabelloMFM = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { pricklypearMFM = 1 }, outputs = { tissueculture = { 4, 4, 6 } } },
 	{ inputs = { raspberryPBJ = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { rattanfiberMFM = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { rattannutMFM = 1 }, outputs = { tissueculture = { 2, 2, 4 } } },
 	{ inputs = { rawcocoabeansMFM = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { redbellpapperMFM = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { rutabagaMFM = 1 }, outputs = { tissueculture = { 4, 4, 6 } } },
 	{ inputs = { shadowbulbMFM = 1 }, outputs = { geneticmaterial = { 3, 3, 5 } } },
 	{ inputs = { strawberryPBJ = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { sugarbeetMFM = 1 }, outputs = { tissueculture = { 3, 3, 5 } } },
 	{ inputs = { sugarcaneBMB = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { sweetpotatoMFM = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { vanillaMFM = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { wholeoatsMFM = 1 }, outputs = { tissueculture = { 3, 3, 5 } } },
 	{ inputs = { yellowbellpepperMFM = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
        -- YesChef! mod Compat
	-- Blended Food
 	{ inputs = { bananashake = 1 }, outputs = { tissueculture = { 3, 3, 5 } } },
 	{ inputs = { blueberryshake = 1 }, outputs = { tissueculture = { 3, 3, 5 } } },
 	{ inputs = { chocolateshake = 1 }, outputs = { tissueculture = { 3, 3, 5 } } },
 	{ inputs = { strawberryshake = 1 }, outputs = { tissueculture = { 3, 3, 5 } } },
 	{ inputs = { vanillashake = 1 }, outputs = { tissueculture = { 3, 3, 5 } } },
 	{ inputs = { whippedcream = 1 }, outputs = { tissueculture = { 3, 3, 5 } } },
 	{ inputs = { whitechocolateshake = 1 }, outputs = { tissueculture = { 3, 3, 5 } } },
	-- Boiled Food
 	{ inputs = { boiledalienfruit = 1 }, outputs = { tissueculture = { 3, 3, 5 }, { liquidwater = { 0, 0, 1 } } },
 	{ inputs = { boiledasparagusCNYC = 1 }, outputs = { tissueculture = { 5, 5, 7 }, { liquidwater = { 0, 0, 1 } } },
 	{ inputs = { boiledautomatoCNYC = 1 }, outputs = { tissueculture = { 5, 5, 7 }, { liquidwater = { 0, 0, 1 } } },
 	{ inputs = { boiledavesmingoCNYC = 1 }, outputs = { tissueculture = { 5, 5, 7 }, { liquidwater = { 0, 0, 1 } } },
	...
	{ inputs = { boiledboltbulbCNYC = 1 }, outputs = { rawminerals = 3 }, { liquidwater = { 0, 0, 1 } } },
 	...
 	{ inputs = { boiledcarrot = 1 }, outputs = { tissueculture = { 5, 5, 7 }, { liquidwater = { 0, 0, 1 } } },
 	{ inputs = { boiledcauliflower = 1 }, outputs = { tissueculture = { 3, 3, 5 }, { liquidwater = { 0, 0, 1 } } },
 	{ inputs = { boiledchiliCNYC = 1 }, outputs = { tissueculture = { 5, 5, 7 }, { liquidwater = { 0, 0, 1 } } },
 	{ inputs = { boiledcoralcreepCNYC = 1 }, outputs = { tissueculture = { 5, 5, 7 }, { liquidwater = { 0, 0, 1 } } },
 	{ inputs = { boiledcorncob = 1 }, outputs = { tissueculture = { 5, 5, 7 }, { liquidwater = { 0, 0, 1 } } },
 	{ inputs = { boiledcrystalplantCNYC = 1 }, outputs = { tissueculture = { 5, 5, 7 }, { liquidwater = { 0, 0, 1 } } },
 	{ inputs = { boiledcucumberCNYC = 1 }, outputs = { tissueculture = { 4, 4, 6 }, { liquidwater = { 0, 0, 1 } } },
 	{ inputs = { boiledcurrentcornCNYC = 1 }, outputs = { tissueculture = { 4, 4, 6 }, { liquidwater = { 0, 0, 1 } } },
 	{ inputs = { boileddiodiaCNYC = 1 }, outputs = { tissueculture = { 4, 4, 6 }, { liquidwater = { 0, 0, 1 } } },
 	{ inputs = { boileddirturchinCNYC = 1 }, outputs = { tissueculture = { 4, 4, 6 }, { liquidwater = { 0, 0, 1 } } },
 	{ inputs = { boileddragonfruitCNYC = 1 }, outputs = { tissueculture = { 5, 5, 7 }, { liquidwater = { 0, 0, 1 } } },
 	{ inputs = { boiledegg = 1 }, outputs = { tissueculture = {1, 1, 2 }, { liquidwater = { 0, 0, 1 } } },
 	{ inputs = { boiledeggshootCNYC = 1 }, outputs = { tissueculture = { 3, 3, 5 }, { liquidwater = { 0, 0, 1 } } },
 	{ inputs = { boiledfeathercrownCNYC = 1 }, outputs = { tissueculture = { 5, 5, 7 }, { liquidwater = { 0, 0, 1 } } },
 	{ inputs = { boiledgarlicCNYC = 1 }, outputs = { tissueculture = { 4, 4, 6 }, { liquidwater = { 0, 0, 1 } } },
	{ inputs = { boiledgingerCNYC = 1 }, outputs = { tissueculture = { 5, 5, 7 }, { liquidwater = { 0, 0, 1 } } },
 	{ inputs = { boiledgrapefruitCNYC = 1 }, outputs = { tissueculture = { 5, 5, 7 }, { liquidwater = { 0, 0, 1 } } },
 	{ inputs = { boiledgrapesCNYC = 1 }, outputs = { tissueculture = { 5, 5, 7 }, { liquidwater = { 0, 0, 1 } } },
 	{ inputs = { boiledgreenappleCNYC = 1 }, outputs = { tissueculture = { 5, 5, 7 }, { liquidwater = { 0, 0, 1 } } },
 	{ inputs = { boiledgreenbellpepperCNYC = 1 }, outputs = { tissueculture = { 5, 5, 7 }, { liquidwater = { 0, 0, 1 } } },
 	{ inputs = { boiledjalapenopepperCNYC = 1 }, outputs = { tissueculture = { 5, 5, 7 }, { liquidwater = { 0, 0, 1 } } },
 	{ inputs = { boiledkelpCNYC = 1 }, outputs = { tissueculture = { 4, 4, 6 }, { liquidwater = { 0, 0, 1 } } },
 	{ inputs = { boiledkiwiCNYC = 1 }, outputs = { tissueculture = { 4, 4, 6 }, { liquidwater = { 0, 0, 1 } } },
 	{ inputs = { boiledlemonCNYC = 1 }, outputs = { tissueculture = { 4, 4, 6 }, { liquidwater = { 0, 0, 1 } } },
 	{ inputs = { boiledlettuceCNYC = 1 }, outputs = { tissueculture = { 4, 4, 6 }, { liquidwater = { 0, 0, 1 } } },
 	{ inputs = { boiledlimeCNYC = 1 }, outputs = { tissueculture = { 4, 4, 6 }, { liquidwater = { 0, 0, 1 } } },
 	{ inputs = { boiledmangoCNYC = 1 }, outputs = { tissueculture = { 4, 4, 6 }, { liquidwater = { 0, 0, 1 } } },
 	{ inputs = { boiledmushroomCNYC = 1 }, outputs = { tissueculture = { 4, 4, 6 }, { liquidwater = { 0, 0, 1  } } },
 	{ inputs = { boiledneonmelonCNYC = 1 }, outputs = { tissueculture = { 3, 3, 5  }, { liquidwater = { 0, 0, 1  } } },
 	{ inputs = { boiledoculemonCNYC = 1 }, outputs = { tissueculture = { 4, 4, 6 }, { liquidwater = { 0, 0, 1 } } },
 	{ inputs = { boiledonionCNYC = 1 }, outputs = { tissueculture = { 5, 5, 7 }, { liquidwater = { 0, 0, 1 } } },
 	{ inputs = { boiledorangebellpepperCNYC = 1 }, outputs = { tissueculture = { 5, 5, 7 }, { liquidwater = { 0, 0, 1 } } },
 	{ inputs = { boiledorangeCNYC = 1 }, outputs = { tissueculture = { 3, 3, 5 }, { liquidwater = { 0, 0, 1 } } },
 	{ inputs = { boiledparsnipCNYC = 1 }, outputs = { tissueculture = { 5, 5, 7 }, { liquidwater = { 0, 0, 1 } } },
 	{ inputs = { boiledpineappleCNYC = 1 }, outputs = { tissueculture = { 5, 5, 7 }, { liquidwater = { 0, 0, 1 } } },
 	{ inputs = { boiledpotato = 1 }, outputs = { tissueculture = { 5, 5, 7 }, { liquidwater = { 0, 0, 1 }} },
 	{ inputs = { boiledpussplumCNYC = 1 }, outputs = { tissueculture = { 5, 5, 7 }, { liquidwater = { 0, 0, 1 } } },
 	{ inputs = { boiledradishCNYC = 1 }, outputs = { tissueculture = { 5, 5, 7 }, { liquidwater = { 0, 0, 1 } } },
 	{ inputs = { boiledredbellpepperCNYC = 1 }, outputs = { tissueculture = { 5, 5, 7 }, { liquidwater = { 0, 0, 1 } } },
 	{ inputs = { boiledredbellpepperCNYC = 1 }, outputs = { tissueculture = { 5, 5, 7 }, { liquidwater = { 0, 0, 1 } } },
 	{ inputs = { boiledrutabagaCNYC = 1 }, outputs = { tissueculture = { 4, 4, 6 }, { liquidwater = { 0, 0, 1 } } },
 	{ inputs = { boiledstrawberryCNYC = 1 }, outputs = { tissueculture = { 5, 5, 7 }, { liquidwater = { 0, 0, 1 } } },
 	{ inputs = { boiledsugarbeetCNYC = 1 }, outputs = { tissueculture = { 3, 3, 5 }, { liquidwater = { 0, 0, 1 } } },
 	{ inputs = { boiledsweetpotatoCNYC = 1 }, outputs = { tissueculture = { 5, 5, 7 }, { liquidwater = { 0, 0, 1 } } },
 	{ inputs = { boiledthornfruitCNYC = 1 }, outputs = { tissueculture = { 5, 5, 7 }, { liquidwater = { 0, 0, 1 } } },
 	{ inputs = { boiledtomatoCNYC = 1 }, outputs = { tissueculture = { 5, 5, 7 }, { liquidwater = { 0, 0, 1 } } },
 	{ inputs = { boiledtoxictopCNYC = 1 }, outputs = { tissueculture = { 5, 5, 7 }, { liquidwater = { 0, 0, 1 } } },
 	{ inputs = { boiledturnipCNYC = 1 }, outputs = { tissueculture = { 5, 5, 7 }, { liquidwater = { 0, 0, 1 } } },
 	{ inputs = { boiledwartweedCNYC = 1 }, outputs = { tissueculture = { 5, 5, 7 }, { liquidwater = { 0, 0, 1 } } },
 	{ inputs = { boiledyellowbellpepperCNYC = 1 }, outputs = { tissueculture = { 5, 5, 7 }, { liquidwater = { 0, 0, 1 } } },
	-- Chopped Food
 	{ inputs = { breadslice = 1 }, outputs = { tissueculture = { 3, 3, 5 } } },
 	{ inputs = { choppedalienfruit = 1 }, outputs = { tissueculture = { 3, 3, 5 } } },
 	{ inputs = { choppedalienmeat = 1 }, outputs = { geneticmaterial = { 4, 4, 6 } } },
 	{ inputs = { choppedartichoke = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { choppedasparagus = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { choppedautomato = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { choppedavesmingo = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { choppedbanana = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { choppedbeakseed = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { choppedbeet = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { choppedblueberries = 1 }, outputs = { tissueculture = { 3, 3, 5 } } },
	{ inputs = { choppedboltbulb = 1 }, outputs = { rawminerals = 3 } },
 	{ inputs = { choppedboneboo = 1 }, outputs = { tissueculture = { 3, 3, 5 } } },
 	{ inputs = { choppedbroccoli = 1 }, outputs = { tissueculture = { 3, 3, 5 } } },
 	{ inputs = { choppedbrusselsprout = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { choppedcarrot = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { choppedcauliflower = 1 }, outputs = { tissueculture = { 3, 3, 5 } } },
 	{ inputs = { choppedchili = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { choppedcoconut = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { choppedcoralcreep = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { choppedcorn = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { choppedcrystalplant = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { choppedcucumber = 1 }, outputs = { tissueculture = { 4, 4, 6 } } },
 	{ inputs = { choppedcurrentcorn = 1 }, outputs = { tissueculture = { 4, 4, 6 } } },
 	{ inputs = { choppeddiodia = 1 }, outputs = { tissueculture = { 4, 4, 6 } } },
 	{ inputs = { choppeddirturchin = 1 }, outputs = { tissueculture = { 4, 4, 6 } } },
 	{ inputs = { choppeddragonfruit = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { choppedegg = 1 }, outputs = { tissueculture = { 1, 1, 2 } } },
 	{ inputs = { choppedeggshoot = 1 }, outputs = { tissueculture = { 3, 3, 5 } } },
 	{ inputs = { choppedfeathercrown = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { choppedgarlic = 1 }, outputs = { tissueculture = { 4, 4, 6 } } },
	{ inputs = { choppedginger = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	...
 	{ inputs = { choppedkiwi = 1 }, outputs = { tissueculture = { 4, 4, 6 } } },
 	{ inputs = { choppedlemon = 1 }, outputs = { tissueculture = { 4, 4, 6 } } },
 	{ inputs = { choppedlettuce = 1 }, outputs = { tissueculture = { 4, 4, 6 } } },
 	{ inputs = { choppedlime = 1 }, outputs = { tissueculture = { 4, 4, 6 } } },
 	{ inputs = { choppedmango = 1 }, outputs = { tissueculture = { 4, 4, 6 } } },
 	{ inputs = { choppedmushroom = 1 }, outputs = { tissueculture = { 4, 4, 6 } } },
 	{ inputs = { choppedneonmelon = 1 }, outputs = { tissueculture = { 4, 4, 6 } } },
 	{ inputs = { choppedoculemon = 1 }, outputs = { tissueculture = { 4, 4, 6 } } },
 	{ inputs = { choppedonion = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { choppedorange = 1 }, outputs = { tissueculture = { 3, 3, 5 } } },
 	{ inputs = { choppedorangebellpepper = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { choppedparsnip = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { choppedpineapple = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { choppedpotato = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { choppedpussplum = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { choppedradish = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { choppedredapple = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { choppedredbellpepper = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { choppedreefpod = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { choppedrutabaga = 1 }, outputs = { tissueculture = { 4, 4, 6 } } },
 	{ inputs = { choppedstrawberry = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { choppedsugarbeet = 1 }, outputs = { tissueculture = { 3, 3, 5 } } },
 	{ inputs = { choppedsweetpotato = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { choppedthornfruit = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { choppedtomato = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { choppedtoxictop = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { choppedturnip = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { choppedwartweed = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
 	{ inputs = { choppedyellowbellpepper = 1 }, outputs = { tissueculture = { 5, 5, 7 } } },
	-- from FU
	...
	{ inputs = { raptoregg2 = 1 }, outputs = { geneticmaterial = { 6, 6, 12 } } },
	{ inputs = { raptoregg3 = 1 }, outputs = { geneticmaterial = { 6, 6, 12 } } },
	{ inputs = { raptoregg4 = 1 }, outputs = { geneticmaterial = { 6, 6, 12 } } },
	{ inputs = { raptoregg5 = 1 }, outputs = { geneticmaterial = { 6, 6, 12 } } },
	...
	{ inputs = { wheat = 1 }, outputs = { tissueculture = { 3, 3, 5 }, phosphorus = { 1, 2, 2 } } },
	...
	{ inputs = { lazuliteore = 4 }, outputs = { phosphorus = { 1, 1, 2 }, magnesiumpowder = { 1, 1, 2 } } },
	{ inputs = { magnesiumore = 2 }, outputs = { magnesiumpowder = { 1, 2, 3 } } },
	{ inputs = { mascagniteore = 2 }, outputs = { ammoniumsulfate = { 1, 2, 3 } } },
