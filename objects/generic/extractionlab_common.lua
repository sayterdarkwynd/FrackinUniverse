...
function getRecipes()
	...
	{ inputs = { bananaseed = 1 }, outputs = { tissueculture = { 3, 3, 5 } } },
	{ inputs = { batterystem = 1 }, outputs = { geneticmaterial = { 2, 2, 5 } } },
	{ inputs = { beakseedseed = 1 }, outputs = { tissueculture = { 3, 3, 4 } } },
	...
	{ inputs = { wildwheatseed = 1 }, outputs = { tissueculture = { 4, 4, 5 }, phosphorus = { 1, 2, 2 } } },
