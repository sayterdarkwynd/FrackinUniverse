function getRecipes()
  return {
    ...
    itemMapBees = {
        ...
        coppercomb      = { copperore      = { "rare", 1 } },
        durasteelcomb   = { durasteelore   = { "rarest", 1 } },
        forestcomb      = { goldenwood     = { "common", 1 } },
        flowercomb      = { petalred       = { "common", 3 },
                            petalyellow    = { "common", 3 },
                            petalblue      = { "common", 3 } },
        godlycomb       = { matteritem     = { "rare", 1 } },
        goldcomb        = { goldore        = { "rarest", 1 } },
        ironcomb        = { ironore        = { "rarest", 1 } },
        ...
        silvercomb      = { silverore      = { "rarest", 1 } },
        solariumcomb    = { solariumore    = { "rare", 1 } },
        suncomb         = { sulphur        = { "rare", 1 } },
        titaniumcomb    = { titaniumore    = { "rarest", 1 } },
        tungstencomb    = { tungstenore    = { "rarest", 1 } },
        volcaniccomb    = { liquidlava     = { "uncommon", 1 } },
        aegisaltcomb    = { aegisaltore    = { "rarest", 1 } },
        feroziumcomb    = { feroziumore    = { "rarest", 1 } },
        violiumcomb     = { violiumore     = { "rarest", 1 } }
      },
    ...
    itemMapIsotopes = {
        ...
        toxicwaste              = { uraniumore             = { "common", 1 },
                                   tritium                 = { "rarest", 1 } },
        uraniumrod              = { enricheduranium        = { "rare", 1 },
                                   toxicwaste              = { "common", 2 },
                                   fu_hydrogen             = { "common", 2 } },
        ...
        neptuniumrod            = { toxicwaste             = { "common", 2 },
                                   fu_hydrogen             = { "common", 2 },
                                   ultronium               = { "rarest", 1 } },
        thoriumrod              = { toxicwaste             = { "common", 2 },
                                   fu_hydrogen             = { "common", 2 },
                                   ultronium               = { "rarest", 1 } },
