function getRecipes()
  return {
    ...
    itemMapLiquids = {
        ...
        liquidorangegravrain= { liquidwastewater       = { "common", 3 },
                               sulphur                 = { "uncommon", 3 },
                               rawminerals             = { "uncommon", 3 },
                               ff_silicon              = { "uncommon", 3 } },                               
        ...
        liquidaether        = { vialproto              = { "rare", 1 },
                               ...
                               fu_carbon               = { "common", 2 } },
        helium3gasliquid        = { fu_hydrogen        = { "common", 1 },
                               liquiddeuterium         = { "rarest", 2 },
                               tritium                 = { "rarest", 2 } },   
        shadowgasliquid        = { fu_nitrogen         = { "common", 1 },
                               liquidelderfluid        = { "rarest", 2 },
                               essence                 = { "rarest", 2 } },                               
        liquidcrystal        = { crystal               = { "common", 1 },
                               aliencompound           = { "rarest", 2 },
                               essence                 = { "rarest", 2 } },                               
