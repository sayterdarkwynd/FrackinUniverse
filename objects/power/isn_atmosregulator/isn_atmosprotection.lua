function init()
  ...
  status.setPersistentEffects("isn_airprotection", {{stat = "pressureProtection", amount = 1}})
  status.setPersistentEffects("isn_airprotection", {{stat = "extremepressureProtection", amount = 1}})
end
