...
--flesh dissection
{inputs = { fuflesh=1 }, outputs = { leather=3,faceskin=1,liquidblood = 40,rawribmeat=2,bone=24,alienmeat=4,fufemur=2,futooth=20}, time = 6.0},
{inputs = { fufleshalien=1 }, outputs = { leather=3,liquidalienjuice = 40,cellmaterial=4,cellmateria=4,rawribmeat=2,bone=24,fufemur=2,futooth=20}, time = 6.0},

--heart dissection
{inputs = { fuheartalien=1 }, outputs = { liquidalienjuice = 5,gene_muscle=1}, time = 6.0},
{inputs = { fuheart=1 }, outputs = { liquidalienjuice = 5,gene_muscle=1}, time = 6.0},
...
{inputs = { cadaver=1 }, outputs = { fuflesh=1, fuhair=1, fubrain=1, fuscienceresource=120, fumadnessresource=30}, time = 8.0},
{inputs = { cadaverrotting=1 }, outputs = { fuflesh=1, fuhair=1, fubrain=1,fuscienceresource=70}, time = 8.0},
{inputs = { cadaverbirb=1 }, outputs = { fuflesh=1, fuhair=1, fubrain=1, blooddiamond=1, goldbar=2, fuscienceresource=90 }, time = 8.0},
{inputs = { cadaveralien=1 }, outputs = { fufleshalien=1,fubrain=1,fuheartalien=1,slew4=12,fuscienceresource=120, fumadnessresource=30 }, time = 8.0},
