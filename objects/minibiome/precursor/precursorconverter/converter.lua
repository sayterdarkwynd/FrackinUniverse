...
{inputs = { irradiumore=12 }, outputs = { precursorfluid=1 }, time = 1.0},
{inputs = { irradiumbar=5 }, outputs = { precursorfluid=1 }, time = 1.0},
{inputs = { liquidirradium=25 }, outputs = { precursorfluid=1 }, time = 1.0},
{inputs = { supermatter=20 }, outputs = { precursorgel=2 }, time = 2.0},
{inputs = { uraniumrod=8 }, outputs = { precursorfluid=1 }, time = 2.0},
{inputs = { plutoniumrod=9 }, outputs = { precursorfluid=1 }, time = 3.0},
{inputs = { neptuniumrod=7 }, outputs = { precursorfluid=1 }, time = 4.0},
{inputs = { thoriumrod=6 }, outputs = { precursorfluid=1 }, time = 5.0},
...
{inputs = { ultronium=1 }, outputs = { precursorfluid=5 }, time = 6.0},
