...
function autoFire()
  ...
  local fireTime = 1
  local projectileParameters = { power = 12, speed=72, knockback=1.5  }
  local energyUsage = 35
  ...
  while true do
    ...
    world.spawnProjectile("ffteslasmall", firePosition(), entity.id(), aimVector, false, projectileParameters)
