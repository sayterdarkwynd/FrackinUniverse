...
function autoFire()
  ...
  local power = 2 * math.max(1.0, world.threatLevel())
  local fireTime = 0.1
  local projectileParameters = { power = power, speed = 72, knockback = 2, inaccuracy = 0.001 }
  local energyUsage = 6
  ...
  while true do
    ...
    world.spawnProjectile("fulaserpistol", firePosition(), entity.id(), aimVector, false, projectileParameters)
