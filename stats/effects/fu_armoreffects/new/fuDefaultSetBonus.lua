...
function fuDefaultSetBonus.new(self, child)
  child = child or {}
...
function fuDefaultSetBonus.init(self, config_file)
...
function fuDefaultSetBonus.uninit(self)
end

--=========================== CORE HELPER FUNCTIONS ==========================--

function fuDefaultSetBonus.isWearingSet(self)
...
function fuDefaultSetBonus.updateBonusWeaponCount(self)
  ...
  local twohanded = (desc ~= nil) or root.itemConfig(desc).config.twoHanded
...
function fuDefaultSetBonus.applyArmorBonuses(self)
...
function fuDefaultSetBonus.removeArmorBonuses(self)
  status.clearPersistentEffects("setbonus")
  effect.removeStatModifierGroup(self.armorBonusGroup)
  self.armorBonusGroup = effect.addStatModifierGroup({})
end

function fuDefaultSetBonus.updateWeaponBonuses(self)
...
function fuDefaultSetBonus.removeWeaponBonuses(self)
...
function fuDefaultSetBonus.update(self)
