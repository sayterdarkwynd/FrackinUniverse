...
function update(dt)
  ...
  erchiusCount = erchiusCount + (world.entityHasCountOfItem(entity.id(), "densiniumore") or 0)
  erchiusCount = erchiusCount + (world.entityHasCountOfItem(entity.id(), "irradiumore") or 0)
  erchiusCount = erchiusCount + (world.entityHasCountOfItem(entity.id(), "triangliumore") or 0)
