...
function build(directory, config, parameters, level, seed)
  ...
  if elementalType ~= "physical" then
    ...
    -- *******************************
    -- FU ADDITIONS 
      config.tooltipFields.forceLabel = util.round(config.projectileParameters.controlForce, 1)  
      config.tooltipFields.knockbackLabel = util.round(config.projectileParameters.knockback, 1)    
