...
function update()
  ...
  local lastPoint = activeItemAnimation.handPosition(activeItemAnimation.animationParameter("ropeOffset"))
  for i = 2, 1000 do
    local nextPoint = activeItemAnimation.animationParameter("p"..i)
