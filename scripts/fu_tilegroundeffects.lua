...
function tileMaterials()
  ...
  self.matCheck["iceblock2"] = {{"iceslip"},1,1,1,14,100,0,1}
  self.matCheck["iceblock3"] = {{"iceslip3"},1,1,1,14,101,1,1.2}
  self.matCheck["iceblock4"] = {{"iceslip2"},1,1,1,14,101,1,1.2}
  self.matCheck["snow"] = {{"snowslow"},1,1,1,14,100,0,1}
