...
function tileMaterials()
  ...
  self.matCheck["mud"] = 	     		{{"fumudslow"},  0.8, 1,   1,   14,   101, 0.25,    0,  1.75, 0}
  self.matCheck["clay"] = 	    		{{"fuclayslow"}, 1,   1,   1,   14,   101,    0,    0,  1.75, 0}
  self.matCheck["sand"] = 	    		{{"jungleslow"}, 1,   1,   1,   14,   101,    0.5,  0,  1.9, 0}
  self.matCheck["rainbowsand"] = 		{{"jungleslow"}, 1,   1,   1,   14,   101,    0.5,  0,  1.2, 0}
  self.matCheck["glowingsand"] = 		{{"glow"},       1,   1,   1,   14,   101,    0.5,  0,  1.2, 0} 
  ...
  self.matCheck["ice"] = 			{{"iceslip"},    1,   1,   1,   14,   100,  0.0,    0,  1, 0}
  self.matCheck["iceblock1"] = 		        {{"iceslip"},    1,   1,   1,   14,   100,  0.0,    0,  1, 0}
  self.matCheck["iceblock2"] = 		        {{"iceslip"},    1,   1,   1,   14,   100,  0.0,    0,  1, 0}
  self.matCheck["iceblock3"] = 		        {{"iceslip3"},   1,   1,   1,   14,   101,  1.0,    0,  1.2, 0}
  self.matCheck["iceblock4"] = 		        {{"iceslip2"},   1,   1,   1,   14,   101,  1.0,    0,  1.2, 0}
  self.matCheck["snow"] = 			{{"snowslow"},   1,   1,   1,   14,   100,  0.0,    0,  1, 0}
  self.matCheck["slush"] = 			{{"slushslow"},  1,   1,   1,   14,   100,  0.0,    0,  1, 0}
  ...
  self.matCheck["raincloud"] = 	                    {{"lowgrav_fallspeed"},1,   1,   1,   14,   101,  1.0,    0,  1.2, 0}
  ...
  self.matCheck["fublueslimedirt"] =   {{"regenerationblock","slimestick"},1,1,1,14,100,0.0,1,1.1, 0}
  self.matCheck["fublueslime"] = 	{{"regenerationblock","slimestick"},1,1,1,14,100,0.0,1,1.1, 0}
