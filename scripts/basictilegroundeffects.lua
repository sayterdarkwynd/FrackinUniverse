...
function tileMaterials()
  ...
  ["mud"] = 	     		{{"fumudslow"},  0.8, 1,   1,   14,   101, 0.25,    0,  1.75, 0},
  ["clay"] = 	    		{{"fuclayslow"}, 1,   1,   1,   14,   101,    0,    0,  1.75, 0},
  ["sand"] = 	    		{{"jungleslow"}, 1,   1,   1,   14,   101,    0.5,  0,  1.9, 0},
  ["rainbowsand"] = 		{{"jungleslow"}, 1,   1,   1,   14,   101,    0.5,  0,  1.2, 0},
  ["glowingsand"] = 		{{"glow"},       1,   1,   1,   14,   101,    0.5,  0,  1.2, 0} ,
  ["crystalsand"] = 		{{"jungleslow"}, 1,   1,   1,   14,   101,    0.5,  0,  1.9, 0},
  ["glasssand"] = 		{{"jungleslow"}, 1,   1,   1,   14,   101,  0.5,    0,  1.9, 0},
  ...
  ["ice"] = 			{{"iceslip"},    1,   1,   1,   14,   100,  0.0,    0,  1, 0},
  ["iceblock1"] = 		{{"iceslip"},    1,   1,   1,   14,   100,  0.0,    0,  1, 0},
  ["iceblock2"] = 		{{"iceslip"},    1,   1,   1,   14,   100,  0.0,    0,  1, 0},
  ["iceblock3"] = 		{{"iceslip3"},   1,   1,   1,   14,   101,  1.0,    0,  1.2, 0},
  ["iceblock4"] = 		{{"iceslip2"},   1,   1,   1,   14,   101,  1.0,    0,  1.2, 0},
  ["snow"] = 			{{"snowslow"},   1,   1,   1,   14,   100,  0.0,    0,  1, 0},
  ["slush"] = 			{{"slushslow"},  1,   1,   1,   14,   100,  0.0,    0,  1, 0},
  ...
  ["raincloud"] = 	                    {{"lowgrav"},1,   1,   1,   14,   101,  1.0,    0,  1.2, 0},
